<template>
  <div class="container mx-auto h-screen">
    <div class="flex flex-wrap h-full -mx-8">
      <aside class="hidden lg:block w-1/4 mt-24 px-8">
        <div class="flex flex-col justify-between h-full">
          <div>
            ...
            <div class="mb-6">
              ...
              <ul>
                <li><a href="#colors" class="leading-7" v-smooth-scroll>Colors</a></li>
                <li><a href="#shadows" class="leading-7" v-smooth-scroll>Shadows</a></li>
                <li><a href="#font-sizes" class="leading-7" v-smooth-scroll>Font sizes</a></li>
              </ul>
            </div>
            <div class="mb-6">
      ...
      <main class="w-3/4 mt-40 px-8">
        <div class="mt-3">
          ...
          <div class="mb-12">
            ...
            <div class="bg-blueGray-50 pt-3 pb-4 pr-3 rounded">
